...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "CH0_DMA_ADDR_BASE" -parent ${Page_0}
...
proc update_PARAM_VALUE.CH0_DMA_ADDR_BASE { PARAM_VALUE.CH0_DMA_ADDR_BASE } {
	# Procedure called to update CH0_DMA_ADDR_BASE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CH0_DMA_ADDR_BASE { PARAM_VALUE.CH0_DMA_ADDR_BASE } {
	# Procedure called to validate CH0_DMA_ADDR_BASE
	return true
}
...
proc update_MODELPARAM_VALUE.CH0_DMA_ADDR_BASE { MODELPARAM_VALUE.CH0_DMA_ADDR_BASE PARAM_VALUE.CH0_DMA_ADDR_BASE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CH0_DMA_ADDR_BASE}] ${MODELPARAM_VALUE.CH0_DMA_ADDR_BASE}
}
