...
`timescale 1 ns / 1 ps
    ...
    reg [31:0] float2b24_input_data_l;
    wire float2b24_rdy_l;
    reg float2b24_valid_l;
    wire [23:0] float2b24_output_data_l;
    wire float2b24_output_valid_l;
    
    reg [31:0] float2b24_input_data_r;
    wire float2b24_rdy_r;
    reg float2b24_valid_r;
    wire [23:0] float2b24_output_data_r;
    wire float2b24_output_valid_r;
    ...
    begin
        if (S_AXIS_ARESETN == 0) begin
            ...
            case (float2b24_state)
                0: begin
                    FIFOTX_WR_EN <= 0;
                    if (tx_l_r_float_valid && float2b24_rdy_l && float2b24_rdy_r) begin
                        tx_l_r_float_rd_en <= 1;
                        float2b24_input_data_l <= tx_l_r_float_outdata[63:32];
                        float2b24_valid_l <= 1;
                        float2b24_input_data_r <= tx_l_r_float_outdata[31:0];
                        float2b24_valid_r <= 1;
                        float2b24_state <= 1;
                    end else begin
                        tx_l_r_float_rd_en <= 0;
                ...
                1: begin
                    ...
                    float2b24_valid_l <= 0;
                    float2b24_valid_r <= 0;
                    if (float2b24_output_valid_l) begin //float2b24_output_valid_r should be valid when l valid.
                        FIFOTX_DATA[47:24] <= float2b24_output_data_l;
                        FIFOTX_DATA[23:0] <= float2b24_output_data_r;
                        FIFOTX_WR_EN <= 1;
                        float2b24_state <= 0;
                    end else begin
                        FIFOTX_WR_EN <= 0;
...
//    end
    ...
    float_to_b24 float_to_b24_l_inst (
        .aclk(S_AXIS_ACLK),
        .s_axis_a_tdata(float2b24_input_data_l),
        .s_axis_a_tready(float2b24_rdy_l),
        .s_axis_a_tvalid(float2b24_valid_l),
        .m_axis_result_tdata(float2b24_output_data_l),
        .m_axis_result_tvalid(float2b24_output_valid_l)
    );
    
    float_to_b24 float_to_b24_r_inst (
        .aclk(S_AXIS_ACLK),
        .s_axis_a_tdata(float2b24_input_data_r),
        .s_axis_a_tready(float2b24_rdy_r),
        .s_axis_a_tvalid(float2b24_valid_r),
        .m_axis_result_tdata(float2b24_output_data_r),
        .m_axis_result_tvalid(float2b24_output_valid_r)
    );
