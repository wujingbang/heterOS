...
################################################################
# This is a generated script based on design: bd_395a
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_0_AXIS_TDEST_WIDTH {4} \
   CONFIG.C_SLOT_0_AXIS_TID_WIDTH {8} \
   CONFIG.C_SLOT_0_AXIS_TUSER_WIDTH {16} \
   ...
   CONFIG.C_SLOT_1_AXIS_TDEST_WIDTH {4} \
   CONFIG.C_SLOT_1_AXIS_TID_WIDTH {8} \
   CONFIG.C_SLOT_1_AXIS_TUSER_WIDTH {16} \
...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports SLOT_1_AXIS] [get_bd_intf_pins g_inst/slot_1_axis]
  ...
  connect_bd_net -net net_slot_0_axis_tdest [get_bd_pins g_inst/m_slot_0_axis_tdest] [get_bd_pins ila_lib/probe3]
  connect_bd_net -net net_slot_0_axis_tid [get_bd_pins g_inst/m_slot_0_axis_tid] [get_bd_pins ila_lib/probe4]
