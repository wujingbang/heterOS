...
--               F:/work/gitea/heterOS/prj_trace-exp/Meffects_constants_testing_3.srcs/sources_1/bd/effects_loop/ip/effects_loop_fft_ctrl_0_1/effects_loop_fft_ctrl_0_1_sim_netlist.vhdl
...
entity effects_loop_fft_ctrl_0_1_fft_ctrl_v1_0_S00_AXI is
  port (
    ...
    inv_flag_latched_reg : out STD_LOGIC;
    \FSM_sequential_config_status_reg[1]\ : out STD_LOGIC;
    \FSM_sequential_config_status_reg[1]_0\ : out STD_LOGIC;
    ...
    inv_flag_latched : in STD_LOGIC;
    config_status : in STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute ORIG_REF_NAME of effects_loop_fft_ctrl_0_1_fft_ctrl_v1_0_S00_AXI : entity is "fft_ctrl_v1_0_S00_AXI";
end effects_loop_fft_ctrl_0_1_fft_ctrl_v1_0_S00_AXI;

architecture STRUCTURE of effects_loop_fft_ctrl_0_1_fft_ctrl_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_config_status[0]_i_1\ : label is "soft_lutpair0";
...
\FSM_sequential_config_status[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F0000FF6"
    )
        port map (
...
\axi_rdata[17]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8830"
    )
        port map (
...
\axi_rdata[22]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8830"
    )
        port map (
...
\axi_rdata[23]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8830"
    )
        port map (
...
\axi_rdata[24]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8830"
    )
        port map (
...
\axi_rdata[26]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8830"
    )
        port map (
...
\axi_rdata[28]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8830"
    )
        port map (
...
inv_flag_latched_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CCCCCCD8F0F0F0F0"
    )
        port map (
      I0 => config_status(1),
      I1 => inv_flag_latched,
      ...
      I4 => config_status(0),
      I5 => s00_axi_aresetn,
      O => \FSM_sequential_config_status_reg[1]\
    );
m00_axis_tvalid_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FAFFFFFF4040FFFF"
    )
        port map (
      I0 => config_status(1),
      I1 => config_status(2),
      ...
      I4 => s00_axi_aresetn,
      I5 => m00_axis_tvalid,
      O => \FSM_sequential_config_status_reg[1]_0\
    );
m00_axis_tvalid_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"06"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity effects_loop_fft_ctrl_0_1_fft_ctrl_v1_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of effects_loop_fft_ctrl_0_1_fft_ctrl_v1_0 : entity is "fft_ctrl_v1_0";
end effects_loop_fft_ctrl_0_1_fft_ctrl_v1_0;

architecture STRUCTURE of effects_loop_fft_ctrl_0_1_fft_ctrl_v1_0 is
  signal \FSM_sequential_config_status[1]_i_1_n_0\ : STD_LOGIC;
  signal \FSM_sequential_config_status[2]_i_1_n_0\ : STD_LOGIC;
  ...
  signal config_status : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \^fft_core_aresetn\ : STD_LOGIC;
  signal fft_core_aresetn_i_1_n_0 : STD_LOGIC;
  signal fft_core_aresetn_i_2_n_0 : STD_LOGIC;
  signal fft_ctrl_v1_0_S00_AXI_inst_n_4 : STD_LOGIC;
  signal fft_ctrl_v1_0_S00_AXI_inst_n_6 : STD_LOGIC;
  signal fft_ctrl_v1_0_S00_AXI_inst_n_7 : STD_LOGIC;
  signal fft_ctrl_v1_0_S00_AXI_inst_n_8 : STD_LOGIC;
  signal inv_flag_latched : STD_LOGIC;
  ...
  signal \^s00_axi_rvalid\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_config_status[2]_i_1\ : label is "soft_lutpair1";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_config_status_reg[0]\ : label is "iSTATE:010,iSTATE0:011,iSTATE1:100,iSTATE2:101,iSTATE3:000,iSTATE4:001";
  attribute FSM_ENCODED_STATES of \FSM_sequential_config_status_reg[1]\ : label is "iSTATE:010,iSTATE0:011,iSTATE1:100,iSTATE2:101,iSTATE3:000,iSTATE4:001";
  attribute FSM_ENCODED_STATES of \FSM_sequential_config_status_reg[2]\ : label is "iSTATE:010,iSTATE0:011,iSTATE1:100,iSTATE2:101,iSTATE3:000,iSTATE4:001";
  attribute SOFT_HLUTNM of fft_core_aresetn_i_2 : label is "soft_lutpair1";
begin
  S_AXI_ARREADY <= \^s_axi_arready\;
  S_AXI_AWREADY <= \^s_axi_awready\;
  S_AXI_WREADY <= \^s_axi_wready\;
  fft_core_aresetn <= \^fft_core_aresetn\;
  m00_axis_tdata(0) <= \^m00_axis_tdata\(0);
  m00_axis_tvalid <= \^m00_axis_tvalid\;
  s00_axi_bvalid <= \^s00_axi_bvalid\;
  s00_axi_rvalid <= \^s00_axi_rvalid\;
\FSM_sequential_config_status[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"C6"
    )
        port map (
      ...
      I1 => config_status(1),
      I2 => config_status(2),
      O => \FSM_sequential_config_status[1]_i_1_n_0\
    );
\FSM_sequential_config_status[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D8"
    )
        port map (
      ...
      I1 => config_status(1),
      I2 => config_status(2),
      O => \FSM_sequential_config_status[2]_i_1_n_0\
    );
\FSM_sequential_config_status_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => fft_ctrl_v1_0_S00_AXI_inst_n_6,
      Q => config_status(0),
      R => fft_core_aresetn_i_1_n_0
    );
\FSM_sequential_config_status_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \FSM_sequential_config_status[1]_i_1_n_0\,
      Q => config_status(1),
      R => fft_core_aresetn_i_1_n_0
    );
\FSM_sequential_config_status_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \FSM_sequential_config_status[2]_i_1_n_0\,
      Q => config_status(2),
      R => fft_core_aresetn_i_1_n_0
    );
aw_en_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => s00_axi_awvalid,
      I4 => s00_axi_wvalid,
      I5 => fft_ctrl_v1_0_S00_AXI_inst_n_4,
      O => aw_en_i_1_n_0
    );
...
fft_core_aresetn_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => s00_axi_aresetn,
      O => fft_core_aresetn_i_1_n_0
    );
fft_core_aresetn_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB41"
    )
        port map (
      ...
      I2 => config_status(2),
      I3 => \^fft_core_aresetn\,
      O => fft_core_aresetn_i_2_n_0
    );
fft_core_aresetn_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => fft_core_aresetn_i_2_n_0,
      Q => \^fft_core_aresetn\,
      R => fft_core_aresetn_i_1_n_0
    );
fft_ctrl_v1_0_S00_AXI_inst: entity work.effects_loop_fft_ctrl_0_1_fft_ctrl_v1_0_S00_AXI
     port map (
      \FSM_sequential_config_status_reg[1]\ => fft_ctrl_v1_0_S00_AXI_inst_n_7,
      \FSM_sequential_config_status_reg[1]_0\ => fft_ctrl_v1_0_S00_AXI_inst_n_8,
      aw_en_reg_0 => fft_ctrl_v1_0_S00_AXI_inst_n_4,
      aw_en_reg_1 => aw_en_i_1_n_0,
      \axi_araddr_reg[2]_0\ => fft_core_aresetn_i_1_n_0,
      axi_arready_reg_0 => \^s_axi_arready\,
      axi_awready_reg_0 => \^s_axi_awready\,
      axi_bvalid_reg_0 => axi_bvalid_i_1_n_0,
      axi_rvalid_reg_0 => axi_rvalid_i_1_n_0,
      axi_wready_reg_0 => \^s_axi_wready\,
      config_status(2 downto 0) => config_status(2 downto 0),
      ...
      inv_flag_latched => inv_flag_latched,
      inv_flag_latched_reg => fft_ctrl_v1_0_S00_AXI_inst_n_6,
      m00_axis_tvalid => \^m00_axis_tvalid\,
...
inv_flag_latched_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => fft_ctrl_v1_0_S00_AXI_inst_n_7,
      Q => inv_flag_latched,
      R => '0'
    );
\m00_axis_tdata[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
m00_axis_tvalid_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => fft_ctrl_v1_0_S00_AXI_inst_n_8,
      Q => \^m00_axis_tvalid\,
      R => '0'
    );
end STRUCTURE;
...
entity effects_loop_fft_ctrl_0_1 is
  ...
  attribute NotValidForBitStream of effects_loop_fft_ctrl_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of effects_loop_fft_ctrl_0_1 : entity is "effects_loop_fft_ctrl_0_1,fft_ctrl_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of effects_loop_fft_ctrl_0_1 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of effects_loop_fft_ctrl_0_1 : entity is "fft_ctrl_v1_0,Vivado 2019.1";
end effects_loop_fft_ctrl_0_1;

architecture STRUCTURE of effects_loop_fft_ctrl_0_1 is
  signal \<const0>\ : STD_LOGIC;
  signal \<const1>\ : STD_LOGIC;
  signal \^m00_axis_tdata\ : STD_LOGIC_VECTOR ( 0 to 0 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of fft_core_aresetn : signal is "xilinx.com:signal:reset:1.0 fft_core_aresetn RST";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of fft_core_aresetn : signal is "XIL_INTERFACENAME fft_core_aresetn, POLARITY ACTIVE_LOW, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m00_axis_aclk : signal is "xilinx.com:signal:clock:1.0 M00_AXIS_CLK CLK";
  attribute X_INTERFACE_PARAMETER of m00_axis_aclk : signal is "XIL_INTERFACENAME M00_AXIS_CLK, ASSOCIATED_BUSIF M00_AXIS, ASSOCIATED_RESET m00_axis_aresetn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN effects_loop_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN effects_loop_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
...
inst: entity work.effects_loop_fft_ctrl_0_1_fft_ctrl_v1_0
     port map (
